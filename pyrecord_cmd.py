# -*- coding: utf-8 -*-
"""
Created on Sun Jun 14 08:49:04 2020
...
"records.txt" automatically')
    ...
    view_all_data function to print and sort
        ...
        if(position_input=='category'):
            ...
            find_list= categories.find_subcategories(find_category)
            #exception 13: there is no such category
            if not categories.is_category_valid(find_category):
